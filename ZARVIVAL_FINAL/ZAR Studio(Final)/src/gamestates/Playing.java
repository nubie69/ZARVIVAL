...
public class Playing extends State implements Statemethods {
    ...
    private BufferedImage backgroundImg, backPines, backPines2, smallCloud, shipImgs[];
...
//    private boolean drawShip = true;
    ...
    public Playing(Game game) {
        ...
        backPines = LoadSave.GetSpriteAtlas(LoadSave.BACK_PINE);
        backPines2 = LoadSave.GetSpriteAtlas(LoadSave.BACK_PINE2);
...
//        drawShip = false;
    ...
    public void draw(Graphics g) {
        g.drawImage(backgroundImg, 0, -90, Game.GAME_WIDTH, Game.GAME_HEIGHT, null);
    ...
    private void drawClouds(Graphics g) {
        for (int i = 0; i < 4; i++)
            g.drawImage(backPines2, i * PINE_WIDTH - (int) (xLvlOffset * 0.3), (int) (180 * Game.SCALE) +130, PINE_WIDTH, PINE_HEIGHT, null);

        for (int i = 0; i < 4; i++)
            g.drawImage(backPines, i * PINE_WIDTH - (int) (xLvlOffset * 0.3), (int) (204 * Game.SCALE) +150, PINE_WIDTH, PINE_HEIGHT, null);
