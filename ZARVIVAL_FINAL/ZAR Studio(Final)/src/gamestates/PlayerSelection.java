...
public class PlayerSelection extends State implements Statemethods {
    ...
    private void loadCharAnimations() {
        ...
        int i = 0;
        characterAnimations[i++] = new CharacterAnimation(PlayerCharacter.GOBLIN);
        characterAnimations[i++] = new CharacterAnimation(PlayerCharacter.REZ);
        characterAnimations[i++] = new CharacterAnimation(PlayerCharacter.SKULL);
