...
public class Credits extends State implements Statemethods {
    ...
    private void loadEntities() {
        ...
        entitiesList.add(new ShowEntity(getIdleAni(LoadSave.GetSpriteAtlas(LoadSave.PLAYER1), 4, 64, 64), (int) (Game.GAME_WIDTH * 0.05), (int) (Game.GAME_HEIGHT * 0.8) - 100));
        entitiesList.add(new ShowEntity(getIdleAni(LoadSave.GetSpriteAtlas(LoadSave.MUSHROOM_SPRITE), 7, 80, 64), (int) (Game.GAME_WIDTH * 0.15), (int) (Game.GAME_HEIGHT * 0.75) -100));
        entitiesList.add(new ShowEntity(getIdleAni(LoadSave.GetSpriteAtlas(LoadSave.PINKSTAR_ATLAS), 8, 32, 32), (int) (Game.GAME_WIDTH * 0.7), (int) (Game.GAME_HEIGHT * 0.75) -10));
//        entitiesList.add(new ShowEntity(getIdleAni(LoadSave.GetSpriteAtlas(LoadSave.SHARK_ATLAS), 5, 384, 128), (int) (Game.GAME_WIDTH * 0.03) - 200 , (int) (Game.GAME_HEIGHT * 0.8) - 450));
        entitiesList.add(new ShowEntity(getIdleAni(LoadSave.GetSpriteAtlas(LoadSave.CANNON_ATLAS), 8, 64, 32), (int) (Game.GAME_WIDTH * 0.8) , (int) (Game.GAME_HEIGHT * 0.8) - 10));
    }
    ...
    public void draw(Graphics g) {
        ...
        g.drawImage(creditsImg, 460, 100, 350, 500 , null);
